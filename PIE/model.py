...
import numpy as np
from .utils import pad_sequences, Progbar, get_chunks, minibatches
...
class Model(object):
    ...
    def restore_session(self, dir_model):
        ...
        """
        self.logger.info("Reloading the latest trained PIE...")
    ...
    def evaluate(self, test):
        """Evaluate PIE on test set

        Args:
            test: instance of class Dataset

        """
        self.logger.info("Testing PIE over test set")
    ...
    def run_epoch(self, train, dev, epoch):
        ...
        Returns:
            f1: (python float), score to select PIE on, higher is better
