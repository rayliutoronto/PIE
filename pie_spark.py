...
vocab_words = {word.strip(): idx for idx, word in enumerate(sc.textFile('/vagrant/data/words.txt').collect())}
vocab_tags = {tag.strip(): idx for idx, tag in enumerate(sc.textFile('/vagrant/data/tags.txt').collect())}
